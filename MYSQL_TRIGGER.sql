...
#1. Auto-update Total Orders on New Order
...
#2. Decrease Total Orders on Order Delete

DELIMITER //

CREATE TRIGGER trg_decreasetotal_orders
...
#4. Set Default Join Date for New Customers
...
#5. Block Negative Order Amounts
DELIMITER //
...
#7. Auto-Cancel Orders Older Than 1 Year
...
#9. Block Duplicate Orders for Same Day
